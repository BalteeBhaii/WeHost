                    ...
                    <div className='col-md-5 col-sm-12 mt-3'>
                        <div className='border border-secondary rounded-3 mb-5 '>
                            <form onSubmit={handleOnSubmit}>
                                ...
                                <div className="form-floating border-bottom border-2">
                                    <input type="text" className="form-control border-0 shadow-none" placeholder='(Optional)' onChange={(e)=>setState(e.target.value)}/>
                                    <label htmlFor="floatingInput">State</label>
                                </div>
                                <div className="form-floating border-bottom">
                                    <input type="number" className="form-control shadow-none border-0 " id="floatingInput" placeholder='0000' onChange={(e)=> setZipCode(e.target.value)} />
