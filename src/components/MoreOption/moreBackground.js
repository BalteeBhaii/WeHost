...
const MoreBackground = ({loadedHandler}) => {
  ...
  return (
    <div className='divBackgroundImage text-light z-0 not-loaded'>
      <img className='hotel-background-image' src="https://images.pexels.com/photos/271624/pexels-photo-271624.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" onLoad={loadedHandler} />
      <div className='center'>
        <div className='container-xxl container-xl container-lg position-relative pt-5' >
          <h1 className='fw-bold text-center destination-main-title'>Check Your Desired Places</h1>
