                ...
                <div className='verify-2nd-list-items-1st-column col-md-7 col-sm-12 row'>
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 h-100 py-3 mb-3'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/profile'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100 '>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/personal-info'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/login-activity'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/security'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/privacy'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/payment'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/notifications'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/worldwide-interest'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/business'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 mb-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/tax'>
                    ...
                    <div className='col-lg-4 mb-3 col-md-6 col-sm-6 col-12 verify-2nd-list-item-holder'>
                        <div className='account-manage-list-item border px-3 py-3 h-100'>
                            ...
                            <div>
                                <Link className="text-black" to='/host/account/coupon'>
